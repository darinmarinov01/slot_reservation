    ...
    <section className="bg-white dark:bg-gray-900 mt-40">
      <Box className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <Box className="mx-auto max-w-screen-sm text-center">
          ...
          <Typography className="mb-4 text-3xl tracking-tight font-bold text-gray-900 md:text-4xl dark:text-white">Something's missing.</Typography>
          <Typography className="mb-4 text-lg font-light text-gray-500 dark:text-gray-400">Sorry, we can't find that page. You'll find lots to explore on the home page. </Typography>
